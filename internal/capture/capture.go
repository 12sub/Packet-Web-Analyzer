...
func (c *Capturer) runMock(store *stats.Store) {
	...
	subnets := []string{"10.0.1", "10.0.2", "10.0.3", "10.0.4", "10.0.5",
		...
		"10.1.0", "10.2.0",
		"192.168.10", "172.20.0", "172.21.0", "172.22.0", "172.23.0", "10.6.0", "10.7.0", "10.8.0", "10.9.0", "10.10.0",
		"192.168.100", "192.168.101", "192.168.102", "192.168.103", "192.168.104",
		"172.30.0", "172.31.0",
		"10.11.0", "10.12.0", "10.13.0", "10.14.0", "10.15.0",
		"192.168.200", "192.168.201", "192.168.202", "192.168.203", "192.168.204",
		"172.40.0", "172.41.0",
		"10.16.0", "10.17.0", "10.18.0", "10.19.0", "10.20.0",
		"192.168.150", "192.168.151", "192.168.152"}
